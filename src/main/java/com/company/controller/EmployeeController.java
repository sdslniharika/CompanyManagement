...
public class EmployeeController {
    ...
    public ResponseEntity<APIResponse<EmployeeDTO>> createEmployee(@PathVariable Long projectId, @Valid @RequestBody EmployeeDTO employeeDTO)
    {
        ...
        APIResponse<EmployeeDTO> apiResponse=new APIResponse<>
                (HttpStatus.CREATED.value(),"Employee Created Successfully" ,
                        EmployeeMapper.toEmployeeDTO(employeeResponse));
    ...
    {
         List<EmployeeDTO> employeeDTOList=employeeService.getAllEmployee().stream().
                 map(EmployeeMapper::toEmployeeDTO).toList();

        APIResponse<List<EmployeeDTO>> apiResponse=new APIResponse<>
                (HttpStatus.OK.value(),"Employees Fetched Successfully" ,
                        employeeDTOList);
    ...
    public ResponseEntity<APIResponse<EmployeeDTO>> getEmployeeById(@PathVariable Long id)
    {
        ...
        APIResponse<EmployeeDTO> apiResponse=new APIResponse<>
                (HttpStatus.OK.value(),"Employee Fetched Successfully" ,
                        EmployeeMapper.toEmployeeDTO(employeeResponse));
        return  ResponseEntity.ok(apiResponse);
    }
   ...
   /* @GetMapping("/{id}/{departmentId}")
    ...
    public ResponseEntity<APIResponse<EmployeeDTO>> updateEmployee(@PathVariable Long id,@Valid @RequestBody EmployeeDTO employeeDTO)
    {
        ...
        APIResponse<EmployeeDTO> apiResponse=new APIResponse<>
                (HttpStatus.OK.value(),"Employee Updated Successfully" ,
                        EmployeeMapper.toEmployeeDTO(employeeResponse));
        return ResponseEntity.ok(apiResponse);
    }
    ...
    public ResponseEntity<APIResponse<String>> deleteEmployee(@PathVariable Long id)
    {
        ...
        APIResponse<String> apiResponse=new APIResponse<>
                (HttpStatus.OK.value(),"Employee Deleted Successfully" ,
                        "Ok");
        return ResponseEntity.ok(apiResponse);
    }
}
